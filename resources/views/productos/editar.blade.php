                    ...
                    <div role="tabpanel" class="tab-pane fade" id="edicion">
                      ...
                      {!! Form::open(array('action' => 'ProductosController@actualizar','class'=>'form','role'=>'form')) !!}
                        ...
                        <div class="form-group" >
                          ...
                          <div class="form-line">
                            {!! Form::select('materiales_id',[],$producto->materiales_id,array( 'class' => 'form-control input-disabled select2-tags', 'data-placeholder' => 'Material', 'style'=>'width: 100%;', 'required','disabled')) !!}
                          </div>          
                        </div>
