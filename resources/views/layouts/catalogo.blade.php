				...
				<div class="col-sm-6 col-md-4 col-lg-3 p-b-35 isotope-item genero_{{ $producto->genero }} categoria_{{ $producto->categorias_id }}">
					...
					<div class="block2">
						...
						<div class="block2-txt flex-w flex-t p-t-14">
							<div class="block2-txt-child1 flex-col-l " title="{{ $producto->nombre }}">
								<a href="#" class="stext-104 cl4 hov-cl1 trans-04 js-name-b2 p-b-6 js-show-modal1 btn-show-more" data-identifier="{{ $producto->id }}">
									{{ substr($producto->nombre,0,31) }}{{ (strlen($producto->nombre) > 31)?"...":"" }}
								</a>
							...
							<div class="block2-txt-child2 flex-r p-t-3">
								...
								<span class="badge badge-pill badge-info">{{ $producto->existencia->disponibles }}</span>
							</div>
						</div>
					</div>
				</div>
...
<!-- Link back to Colorlib can't be removed. Template is licensed under CC BY 3.0. -->
	...
	<!-- Modal1 pictures -->
	<div class="wrap-modal1 js-modal1 p-t-60 p-b-20" id="modal-pictures">
		<div class="overlay-modal1 js-hide-modal1"></div>

		<div class="container">
			<div class="bg0 p-t-60 p-b-30 p-lr-15-lg how-pos3-parent">
				<button class="how-pos3 hov3 trans-04 js-hide-modal1">
					<img src="{{ asset('templates/cozastore/images/icons/icon-close.png') }}" alt="CLOSE">
				</button>

				<span id="loadPictureModal"></span>
	...
	<script type="text/javascript">
		$(function(){
			$('.btn-show-more').click(function(event) {
				var producto_id = $(this).data('identifier');
				var url = "{{ url('catalogos/modal_producto/') }}/"+producto_id;

				$('#loadPictureModal').load(url);
			});
		});
	</script>
